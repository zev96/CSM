  ...
  <div class="flex h-full flex-col" style="gap: var(--density-gap)">
    ...
    >
      ...
      <div
        ...
        @mouseenter="(e) => { (e.currentTarget as HTMLElement).style.borderColor = 'var(--line-2)'; (e.currentTarget as HTMLElement).style.boxShadow = '0 6px 16px -8px rgba(28,26,23,0.18)'; }"
