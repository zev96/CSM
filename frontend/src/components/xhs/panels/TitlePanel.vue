...
.xhs-title-add-input { flex: 1; min-width: 0; border: 1px solid var(--line-2); border-radius: 8px; padding: 7px 10px; font-size: 13px; outline: none; color: var(--ink); background: var(--card-white); }
