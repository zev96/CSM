"""Template manager page — left/right QSplitter layout.

Left:  TemplateListPanel  (directory selector + template list)
Right: TemplateEditorPanel (three-tab editor)
...
class TemplateManagerPage(QWidget):
    ...
    def __init__(self, config: AppConfig, parent=None):
        ...
        self.list_panel = TemplateListPanel(self.splitter)
        self.list_panel.setMinimumWidth(240)

        self.editor_panel = TemplateEditorPanel(self.splitter)
